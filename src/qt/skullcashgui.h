...
/**
  SkullCash GUI main class. This class represents the main window of the SkullCash UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SkullCashGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit SkullCashGUI(QWidget *parent = 0);
    ~SkullCashGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a skullcash wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
