...
SkullCashGUI::SkullCashGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
    ...
    blockBrowserPage(0)
{
    ...
    setWindowTitle(tr("SkullCash") /*+ " - " + tr("Pot")*/);
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/skullcash"));
    setWindowIcon(QIcon(":icons/skullcash"));
#else
...
void SkullCashGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SkullCash address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/skullcash"), tr("&About SkullCash"), this);
    aboutAction->setToolTip(tr("Show information about SkullCash"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for SkullCash"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/skullcash"), tr("&Show / Hide"), this);
...
void SkullCashGUI::createMenuBar()
{
...
void SkullCashGUI::createToolBars()
{
    ...
    if (!fUseBlackTheme)
        toolbar->setStyleSheet("QToolButton { font-weight:bold;} QToolButton:hover { background-color: #ffce54 } QToolButton:checked { background-color: #ffce54} QToolButton:pressed { background-color: #ffaf00 } #tabs { background-color: #ffaf00; border: none }");
    else if (fUseBlackTheme)
        toolbar->setStyleSheet("QToolButton { color: #ffaf00; font-weight:bold;} QToolButton:hover { color: #a87300; background-color: #ffce54 } QToolButton:checked { color: #a87300; background-color: #ffce54 } QToolButton:pressed { color: #ffce54; background-color: #ffaf00 } #tabs { background-color: #ffce54; border: none }");
...
void SkullCashGUI::setClientModel(ClientModel *clientModel)
{
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/skullcash_testnet"));
            setWindowIcon(QIcon(":icons/skullcash_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/skullcash_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("SkullCash client") + QString(" ") + tr("[testnet]"));
...
void SkullCashGUI::setWalletModel(WalletModel *walletModel)
{
...
void SkullCashGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
    ...
    trayIcon->setToolTip(tr("SkullCash client"));
...
#ifndef Q_OS_MAC
void SkullCashGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void SkullCashGUI::optionsClicked()
{
...
void SkullCashGUI::aboutClicked()
{
    AboutDialog dlg;
...
void SkullCashGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SkullCash network", "", count));
}

void SkullCashGUI::setNumBlocks(int count)
{
...
void SkullCashGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("SkullCash") + " - ";
...
void SkullCashGUI::changeEvent(QEvent *e)
{
...
void SkullCashGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void SkullCashGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(SkullCashUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void SkullCashGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(SkullCashUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void SkullCashGUI::gotoOverviewPage()
{
...
void SkullCashGUI::gotoHistoryPage()
{
...
void SkullCashGUI::gotoAddressBookPage()
{
...
void SkullCashGUI::gotoBlockBrowser(QString transactionId)
{
...
void SkullCashGUI::gotoReceiveCoinsPage()
{
...
void SkullCashGUI::gotoSendCoinsPage()
{
...
void SkullCashGUI::gotoSignMessageTab(QString addr)
{
...
void SkullCashGUI::gotoVerifyMessageTab(QString addr)
{
...
void SkullCashGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void SkullCashGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SkullCash address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void SkullCashGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void SkullCashGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void SkullCashGUI::encryptWallet()
{
    if(!walletModel)
        return;
...
void SkullCashGUI::backupWallet()
{
...
void SkullCashGUI::changePassphrase()
{
...
void SkullCashGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void SkullCashGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void SkullCashGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void SkullCashGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
void SkullCashGUI::updateStakingIcon()
{
    updateWeight();
...
void SkullCashGUI::detectShutdown()
{
