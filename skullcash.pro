...
contains(SKULL_NEED_QT_PLUGINS, 1) {
    DEFINES += SKULL_NEED_QT_PLUGINS
...
HEADERS += src/qt/skullcashgui.h \
    ...
    src/qt/skullcashaddressvalidator.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
    src/chainparams.h \
...
SOURCES += src/qt/skullcash.cpp src/qt/skullcashgui.cpp \
    ...
    src/qt/skullcashaddressvalidator.cpp \
    src/chainparams.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/txmempool.cpp \
    ...
    src/qt/skullcashstrings.cpp \
    src/qt/skullcashamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/skullcash.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/skullcash_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/skullcash-qt.rc
...
windows:RC_FILE = src/qt/res/skullcash-qt.rc
...
macx:ICON = src/qt/res/icons/skullcash.icns
macx:TARGET = "SkullCash-Qt"
